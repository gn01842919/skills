...
3. Invoke the `setup-matt-pocock-skills` skill in your agent. It will:
...
I built these skills as a way to fix common failure modes I see with Codex and other coding agents.
...
- **[git-guardrails-codex](./skills/misc/git-guardrails-codex/SKILL.md)** - Set up Codex hooks to block dangerous GitHub CLI (`gh`) operations before they execute.
