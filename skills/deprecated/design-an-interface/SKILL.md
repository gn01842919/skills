...
Produce 3+ designs. If the user explicitly allows sub-agents when invoking this skill, spawn Codex sub-agents in parallel with bounded design briefs. Otherwise, generate the alternatives yourself from separate constraints. Each design must produce a **radically different** approach.
