...
A collection of agent skills loaded by Codex. Skills are organized into buckets and consumed by per-repo configuration emitted by the `setup-matt-pocock-skills` skill.
